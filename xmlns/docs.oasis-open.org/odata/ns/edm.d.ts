...
// Source files:
// http://docs.oasis-open.org/odata/odata/v4.0/errata03/os/complete/schemas/edm.xsd
...
export type TDecimalConstantExpression = number;
type _TDecimalConstantExpression = Primitive._number;
...
export type TPathExpression = string;
type _TPathExpression = _TPathWithTermSegments;

export type TPathWithTermSegments = string;
type _TPathWithTermSegments = Primitive._string;
